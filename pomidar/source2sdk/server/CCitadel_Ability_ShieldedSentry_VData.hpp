...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_InnateModifier[0x10]; // 0x16f8            
            ...
            float m_flDamageFalloffEndScale; // 0x1718            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ShieldedSentry_VData) == 0x1720);
    };
};
