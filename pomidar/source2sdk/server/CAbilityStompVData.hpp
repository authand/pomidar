...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_strCastDelayLocalPlayerSound; // 0x17e8            
            ...
            char m_BulletResistModifier[0x10]; // 0x1808            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityStompVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityStompVData) == 0x1818);
    };
};
