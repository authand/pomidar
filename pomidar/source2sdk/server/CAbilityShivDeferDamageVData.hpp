...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ActiveCastParticle[0xe0]; // 0x16f8            
            // metadata: MPropertyStartGroup "+Defer Properties"
            float m_flDeferredDamageApplicationInterval; // 0x17d8            
        ...
        static_assert(sizeof(source2sdk::server::CAbilityShivDeferDamageVData) == 0x17e0);
    };
};
