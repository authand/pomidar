...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ChargeBombModifier[0x10]; // 0x16f8            
            ...
            float m_flChargeForMaxDamage; // 0x17f8            
            float m_flMinDamagePercent; // 0x17fc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadelAbilityChargedBombVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadelAbilityChargedBombVData) == 0x1800);
    };
};
