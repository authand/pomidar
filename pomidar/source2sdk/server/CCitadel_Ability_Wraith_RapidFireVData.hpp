...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_TargetBuffSound; // 0x17d8            
            ...
            char m_RapidFireModifier[0x10]; // 0x17e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Wraith_RapidFireVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Wraith_RapidFireVData) == 0x17f8);
    };
};
