...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ProjectileImpactParticle[0xe0]; // 0x1788            
            ...
            char m_TargetModifier[0x10]; // 0x1868            
            ...
            char m_FriendlyOnlyModifier[0x10]; // 0x1878            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Item_TrackingProjectileApplyModifierVData) == 0x1888);
    };
};
