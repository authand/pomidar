...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EnemyModifier[0x10]; // 0x16f8            
            ...
            char m_AoEPlayerParticle[0xe0]; // 0x1718            
