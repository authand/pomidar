...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_HealBeamParticle[0xe0]; // 0x16f8            
            ...
            char m_HealTargetParticle[0xe0]; // 0x17d8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strHealCastSound; // 0x18b8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityMedicHealVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityMedicHealVData) == 0x18c8);
    };
};
