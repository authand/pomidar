...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DamageParticle[0xe0]; // 0x1798            
            ...
            char m_PurgeCastParticle[0xe0]; // 0x1878            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_PurgeSound; // 0x1958            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemCapacitorVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CItemCapacitorVData) == 0x1968);
    };
};
