...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SpilledBloodModifier[0x10]; // 0x17d8            
            // metadata: MPropertyStartGroup "Misc"
            CUtlString m_strBloodSpillStatName; // 0x17e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_BloodBombVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_BloodBombVData) == 0x17f0);
    };
};
