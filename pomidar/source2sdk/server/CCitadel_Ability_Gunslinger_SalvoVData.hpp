...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BulletWarningParticle[0xe0]; // 0x16f8            
            ...
            char m_ProcWatcherModifier[0x10]; // 0x17d8            
            ...
            char m_VictimWarningModifier[0x10]; // 0x17e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Gunslinger_SalvoVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Gunslinger_SalvoVData) == 0x17f8);
    };
};
