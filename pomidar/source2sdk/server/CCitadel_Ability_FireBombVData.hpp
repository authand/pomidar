...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            CSoundEventName m_ExplodeSound; // 0x17d8            
            ...
            char m_ProgressBarModifier[0x10]; // 0x17e8            
            ...
            char m_FireBombModifier[0x10]; // 0x17f8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_FireBombVData) == 0x1818);
    };
};
