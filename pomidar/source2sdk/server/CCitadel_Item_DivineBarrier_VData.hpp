...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_DivineBarrierModifier[0x10]; // 0x1788            
            ...
            char m_CastParticle[0xe0]; // 0x1798            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_DivineBarrier_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_DivineBarrier_VData) == 0x1878);
    };
};
