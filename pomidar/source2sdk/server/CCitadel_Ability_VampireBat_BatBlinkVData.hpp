...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BlinkStartParticle[0xe0]; // 0x16f8            
            ...
            char m_BlinkEndParticle[0xe0]; // 0x17d8            
            ...
            char m_BlinkTravelParticle[0xe0]; // 0x18b8            
            ...
            char m_SelfBuffModifier[0x10]; // 0x1998            
            // m_BuffModifier has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CEmbeddedSubclass<source2sdk::server::CCitadelModifier> m_BuffModifier;
            char m_BuffModifier[0x10]; // 0x19a8            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceTeleport; // 0x19b8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_BlinkStartSound; // 0x1a40            
            CSoundEventName m_BlinkEndSound; // 0x1a50            
            CSoundEventName m_BlinkEndFinalSound; // 0x1a60            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_VampireBat_BatBlinkVData) == 0x1a80);
    };
};
