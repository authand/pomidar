...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_CastCompleteParticle[0xe0]; // 0x1788            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBuffGainedSound; // 0x1868            
            ...
            char m_InvisModifier[0x10]; // 0x1878            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_UtilityUpgrade_AOESmokeBombVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_UtilityUpgrade_AOESmokeBombVData) == 0x1888);
    };
};
