...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_LaserModifier[0x10]; // 0x16f8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strLaserStartSound; // 0x1708            
            CSoundEventName m_strLaserEndSound; // 0x1718            
            CSoundEventName m_strLaserLoopSound; // 0x1728            
            CSoundEventName m_strLaserHitSound; // 0x1738            
            ...
            char m_ChargeParticle[0xe0]; // 0x1748            
            ...
            char m_BeamParticle[0xe0]; // 0x1828            
            ...
            char m_HitParticle[0xe0]; // 0x1908            
            ...
            char m_GroundParticle[0xe0]; // 0x19e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityTokamakHotShotVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityTokamakHotShotVData) == 0x1ac8);
    };
};
