...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_CastOtherParticle[0xe0]; // 0x16f8            
            ...
            char m_ArmorModifier[0x10]; // 0x17d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Protection_RacketVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Protection_RacketVData) == 0x17e8);
    };
};
