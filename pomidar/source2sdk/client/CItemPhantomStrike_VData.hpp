...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_PullDownModifier[0x10]; // 0x1798            
            ...
            char m_ImpactParticle[0xe0]; // 0x18a8            
            ...
            char m_BuffParticle[0xe0]; // 0x1988            
            // metadata: MPropertyGroupName "Gameplay"
            float m_flTeleportDistance; // 0x1a68            
            float m_flVelocityScale; // 0x1a6c            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CItemPhantomStrike_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CItemPhantomStrike_VData) == 0x1a70);
    };
};
