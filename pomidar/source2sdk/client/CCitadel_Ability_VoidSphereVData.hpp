...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_strCastEffect[0xe0]; // 0x1708            
            ...
            char m_strAllyPositionPreview[0xe0]; // 0x17e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_VoidSphereVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_VoidSphereVData) == 0x18c8);
    };
};
