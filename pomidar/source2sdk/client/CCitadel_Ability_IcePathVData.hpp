...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_IcePathModifier[0x10]; // 0x16f8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flMomentumDecayRate; // 0x1708            
            float m_flMomentumWeight; // 0x170c            
            float m_flMaxPitchChange; // 0x1710            
            float m_flMaxPitchUp; // 0x1714            
            float m_flMaxPitchDown; // 0x1718            
            float m_flMaxHeight; // 0x171c            
            float m_flForwardAngleBias; // 0x1720            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_IcePathVData) == 0x1728);
    };
};
