...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ChargeUpParticle[0xe0]; // 0x16f8            
            ...
            char m_InvisModifier[0x10]; // 0x17d8            
