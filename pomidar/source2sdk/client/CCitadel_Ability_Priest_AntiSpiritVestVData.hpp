...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ProcParticle[0xe0]; // 0x16f8            
            ...
            char m_ShieldBreakModifier[0x10]; // 0x17e8            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Priest_AntiSpiritVestVData) == 0x1808);
    };
};
