...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_AreaModifier[0x10]; // 0x16f8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flGroundHeightOffset; // 0x1708            
            float m_flGroundDistance; // 0x170c            
            float m_flSearchUpDistance; // 0x1710            
            float m_flSearchDownDistance; // 0x1714            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Bookworm_AOEMagicVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Bookworm_AOEMagicVData) == 0x1718);
    };
};
