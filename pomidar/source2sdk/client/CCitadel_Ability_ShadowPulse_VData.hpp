...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_AoEParticle[0xe0]; // 0x17e8            
            ...
            char m_EffectParticle[0xe0]; // 0x18c8            
            ...
            char m_HitParticle[0xe0]; // 0x19a8            
            ...
            char m_RadiusParticle[0xe0]; // 0x1a88            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strExpireSound; // 0x1b68            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceInShadow; // 0x1b78            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ShadowPulse_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ShadowPulse_VData) == 0x1c00);
    };
};
