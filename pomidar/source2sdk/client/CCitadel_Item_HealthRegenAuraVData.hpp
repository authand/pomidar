...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_HealParticle[0xe0]; // 0x1788            
            ...
            char m_CastHealParticle[0xe0]; // 0x1868            
            ...
            char m_HealingPulseTrackerModifier[0x10]; // 0x1948            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_HealthRegenAuraVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Item_HealthRegenAuraVData) == 0x1958);
    };
};
