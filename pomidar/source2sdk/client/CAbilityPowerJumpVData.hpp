...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_JumpParticle[0xe0]; // 0x16f8            
            ...
            char m_InAirModifier[0x10]; // 0x17d8            
            ...
            char m_PowerJumpModifier[0x10]; // 0x17e8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityPowerJumpVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityPowerJumpVData) == 0x17f8);
    };
};
