...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EarnedParticle[0xe0]; // 0x1788            
            ...
            char m_GoldModifier[0x10]; // 0x1868            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEarnedSound; // 0x1878            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Item_TrophyCollectorVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Item_TrophyCollectorVData) == 0x1888);
    };
};
