...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SlowDebuffModifier[0x10]; // 0x16f8            
            ...
            char m_DaggerStuckParticle[0xe0]; // 0x1708            
            ...
            char m_DaggerImpactParticle[0xe0]; // 0x17e8            
            ...
            char m_DaggerExplodeParticle[0xe0]; // 0x18c8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strDaggerHitSound; // 0x19a8            
            CSoundEventName m_strDaggerExplodeSound; // 0x19b8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ViperHookBladeVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_ViperHookBladeVData) == 0x19c8);
    };
};
