...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_SuccessModifier[0x10]; // 0x1788            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strSuccessSound; // 0x1798            
            CSoundEventName m_strFailureSound; // 0x17a8            
            CSoundEventName m_strWindowEnteredSound; // 0x17b8            
            ...
            char m_SuccessParticle[0xe0]; // 0x17c8            
            ...
            char m_FailureParticle[0xe0]; // 0x18a8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flGraceTime; // 0x1988            
        ...
        static_assert(sizeof(source2sdk::server::CItem_ActiveReload_VData) == 0x1990);
    };
};
