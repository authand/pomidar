...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraCancelledTransitionBacktoArcher; // 0x16f8            
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraExplodedTransitionBackToArcher; // 0x1780            
            float m_flCameraHoldAtExplosion; // 0x1808            
            float m_flFadeToBlackTime; // 0x180c            
            ...
            char m_SpectatingProjectileParticle[0xe0]; // 0x1810            
            ...
            char m_ExplosionParticle[0xe0]; // 0x18f0            
            ...
            char m_GuidedArrowChannelParticle[0xe0]; // 0x19d0            
            ...
            char m_ProjectileModel[0xe0]; // 0x1ab0            
            float m_ArrowOffsetX; // 0x1b90            
            float m_ArrowCameraDistance; // 0x1b94            
            float m_ArrowCameraHeightOffset; // 0x1b98            
            float m_ArrowInitialPitch; // 0x1b9c            
            ...
            char m_KillCheckModifier[0x10]; // 0x1bc0            
            // metadata: MPropertyGroupName "Sounds"
            CSoundEventName m_strExplodeSound; // 0x1bd0            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flTrackAmount; // 0x1be0            
            float m_flSpeedAccel; // 0x1be4            
            float m_flSpeedDeccel; // 0x1be8            
            float m_flBaseProjectileSpeed; // 0x1bec            
            float m_flMaxProjectileSpeed; // 0x1bf0            
            float m_flArrowModelTurnSpringStrength; // 0x1bf4            
            float m_flKillCheckWindow; // 0x1bf8            
            float m_flWorldCollideGraceWindow; // 0x1bfc            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityGuidedArrowVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityGuidedArrowVData) == 0x1c00);
    };
};
