...
namespace source2sdk
{
    namespace server
    {
        ...
        #pragma pack(push, 1)
        class CCitadel_Modifier_CatapultDamageWatcherVData : public source2sdk::server::CCitadelModifierVData
        {
        public:
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Modifier_CatapultDamageWatcherVData) == 0x770);
    };
};
