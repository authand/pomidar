...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_PetrifyModifier[0x10]; // 0x17e8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strBolaExplodeSound; // 0x17f8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Viper_PetrifyBolaVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Viper_PetrifyBolaVData) == 0x1808);
    };
};
