...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_BarrageCasterModifier[0x10]; // 0x16f8            
            ...
            char m_AmpModifier[0x10]; // 0x1708            
            ...
            char m_ChannelParticle[0xe0]; // 0x18e8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strProjectileLaunchSound; // 0x19c8            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flAttackInterval; // 0x19d8            
        ...
        static_assert(sizeof(source2sdk::server::CAbility_Synth_Barrage_VData) == 0x19e0);
    };
};
