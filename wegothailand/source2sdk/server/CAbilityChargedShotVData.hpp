...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_ChannelParticle[0xe0]; // 0x16f8            
            ...
            char m_ChannelStartParticle[0xe0]; // 0x17d8            
            ...
            char m_ShootParticle[0xe0]; // 0x18b8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityChargedShotVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::server::CAbilityChargedShotVData) == 0x1998);
    };
};
