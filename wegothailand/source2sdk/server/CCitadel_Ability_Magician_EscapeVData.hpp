...
namespace source2sdk
{
    namespace server
    {
        ...
        public:
            ...
            char m_EscapedModifier[0x10]; // 0x16f8            
            ...
            char m_PoofParticle[0xe0]; // 0x1708            
            ...
            char m_TetherParticle[0xe0]; // 0x17e8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strEscaped; // 0x18c8            
        ...
        static_assert(sizeof(source2sdk::server::CCitadel_Ability_Magician_EscapeVData) == 0x1960);
    };
};
