...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_SpiderExplodeParticle[0xe0]; // 0x16f8            
            ...
            char m_JarExplodeParticle[0xe0]; // 0x17d8            
            ...
            char m_SpiritStealDebuffModifier[0x10]; // 0x18b8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Trapper_SpiderJar_VData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Trapper_SpiderJar_VData) == 0x18c8);
    };
};
