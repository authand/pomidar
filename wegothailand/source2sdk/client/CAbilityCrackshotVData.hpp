...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ExplosionVictimParticle[0xe0]; // 0x17d8            
            ...
            char m_ReadyParticle[0xe0]; // 0x18b8            
            ...
            char m_CrackshotImmuneModifier[0x10]; // 0x19a8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_HeadShotVictimSound; // 0x19b8            
            CSoundEventName m_HeadShotConfirmationSound; // 0x19c8            
            CSoundEventName m_ReadySound; // 0x19d8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CAbilityCrackshotVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CAbilityCrackshotVData) == 0x19e8);
    };
};
