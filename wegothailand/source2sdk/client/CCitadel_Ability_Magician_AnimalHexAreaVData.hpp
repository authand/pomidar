...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_HexAreaModifier[0x10]; // 0x16f8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_TargetWarningSound; // 0x1708            
            CSoundEventName m_ProjectileHitConfirm; // 0x1718            
            ...
            char m_AreaWarningEffect[0xe0]; // 0x1728            
        };
        #pragma pack(pop)
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Magician_AnimalHexAreaVData) == 0x1808);
    };
};
