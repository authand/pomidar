...
namespace source2sdk
{
    namespace client
    {
        ...
        {
        public:
            float m_flResupplyForceScale; // 0x16f8            
            float m_flResupplyUp; // 0x16fc            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strKilledSound; // 0x1700            
            CSoundEventName m_strDeploySound; // 0x1710            
            ...
            char m_DispenserModel[0xe0]; // 0x1730            
            ...
            char m_SprayParticle[0xe0]; // 0x1810            
            ...
            char m_DestroyedParticle[0xe0]; // 0x18f0            
            ...
            char m_DeployParticle[0xe0]; // 0x19d0            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_MobileResupplyVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_MobileResupplyVData) == 0x1ab0);
    };
};
