...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_ModifierSurgingPower[0x10]; // 0x1788            
            ...
            char m_CastTargetEffect[0xe0]; // 0x1798            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_WeaponUpgrade_SurgingPowerVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_WeaponUpgrade_SurgingPowerVData) == 0x1878);
    };
};
