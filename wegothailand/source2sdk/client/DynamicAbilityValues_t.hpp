...
namespace source2sdk
{
    namespace client
    {
        ...
        static_assert(offsetof(source2sdk::client::DynamicAbilityValues_t, m_TargetAbilityID) == 0x34);
        static_assert(offsetof(source2sdk::client::DynamicAbilityValues_t, m_eValType) == 0x38);
        static_assert(offsetof(source2sdk::client::DynamicAbilityValues_t, m_flValue) == 0x3c);
        
        static_assert(sizeof(source2sdk::client::DynamicAbilityValues_t) == 0x40);
    };
};
