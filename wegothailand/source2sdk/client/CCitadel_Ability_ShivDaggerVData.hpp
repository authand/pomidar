...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_DamageDebuffModifier[0x10]; // 0x16f8            
            ...
            char m_SlowDebuffModifier[0x10]; // 0x1708            
            ...
            char m_DaggerStuckParticle[0xe0]; // 0x1718            
            ...
            char m_DaggerImpactParticle[0xe0]; // 0x17f8            
            ...
            char m_DaggerExplodeParticle[0xe0]; // 0x18d8            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strDaggerHitSound; // 0x19b8            
            CSoundEventName m_strDaggerExplodeSound; // 0x19c8            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_ShivDaggerVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_ShivDaggerVData) == 0x19d8);
    };
};
