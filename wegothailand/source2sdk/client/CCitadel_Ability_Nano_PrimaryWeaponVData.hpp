...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_EscapeModifier[0x10]; // 0x1748            
            ...
            char m_SlashEffectParticle[0xe0]; // 0x1758            
            // metadata: MPropertyStartGroup "Sounds"
            CSoundEventName m_strExpireSound; // 0x1838            
            // metadata: MPropertyStartGroup "Camera"
            source2sdk::client::CitadelCameraOperationsSequence_t m_cameraSequenceInShadow; // 0x1848            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Nano_PrimaryWeaponVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Nano_PrimaryWeaponVData) == 0x18d0);
    };
};
