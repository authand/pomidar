...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            CSoundEventName m_ShootSound; // 0x1718            
            CSoundEventName m_ExplodeSound; // 0x1728            
            // metadata: MPropertyStartGroup "Visuals"
            // m_ExplodeParticle has a template type with potentially unknown template parameters. You can try uncommenting the field below.
            // CResourceNameTyped<CWeakHandle<source2sdk::resourcesystem::InfoForResourceTypeIParticleSystemDefinition>> m_ExplodeParticle;
            char m_ExplodeParticle[0xe0]; // 0x1738            
            ...
            char m_ShootParticle[0xe0]; // 0x1818            
        };
        #pragma pack(pop)
        
        // Cannot assert offsets of fields in CCitadel_Ability_Priest_BarrageVData because it is not a standard-layout class
        
        static_assert(sizeof(source2sdk::client::CCitadel_Ability_Priest_BarrageVData) == 0x18f8);
    };
};
