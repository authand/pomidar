...
namespace source2sdk
{
    namespace client
    {
        ...
        public:
            ...
            char m_LaunchParticle[0xe0]; // 0x1788            
            ...
            char m_InAirWatcherModifier[0x10]; // 0x1868            
            // metadata: MPropertyStartGroup "Gameplay"
            float m_flMinHeadClearance; // 0x1878            
        ...
        static_assert(sizeof(source2sdk::client::CCitadel_UtilityUpgrade_RocketBootsVData) == 0x1880);
    };
};
